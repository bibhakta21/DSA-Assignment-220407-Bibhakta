...
public class Question2B {
    ...
    public static List<Integer> determineSecretRecipients(int n, int[][] intervals, int firstPerson) {
        // Initialize a boolean array to track whether each person knows the secret
        ...
        // Iterate through each interval and update the knowsSecret array accordingly
        ...
        // Store the indices of individuals who know the secret
    ...
    public static void main(String[] args) {
        ...
        int firstPerson = 0; // Initial person possessing the secret

        // Determine the secret recipients and print the result
        List<Integer> result = determineSecretRecipients(n, intervals, firstPerson);
        System.out.println("The individual who will know secrets are: "+result); // Output: [0, 1, 2, 3, 4]
    }
}